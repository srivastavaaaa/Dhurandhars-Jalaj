    ...
    <div className="max-w-4xl mx-auto px-6 py-10 space-y-8">
      ...
      {loading ? (
        ...
        <div className="bg-white border border-slate-100 rounded-3xl p-12 text-center text-slate-500 space-y-4">
          ...
          <Link href="/dashboard/profile" className="text-xs font-semibold text-emerald-600 underline">
        ...
        <div className="space-y-6">
          {matches.map((match) => {
            ...
            return (
              <div key={match.id} className="bg-white border border-slate-100 rounded-3xl p-6 shadow-sm space-y-6 hover:shadow-md transition">
                {/* Upper block */}
                <div className="flex flex-col md:flex-row md:items-start justify-between gap-4">
                  <div className="space-y-2">
                    <div className="flex items-center space-x-2 flex-wrap gap-y-1">
                      ...
                      <span className="bg-emerald-50 text-emerald-700 text-[10px] px-2.5 py-0.5 rounded-full font-semibold flex items-center space-x-1">
                        <Award size={10} />
                ...
                <div className="flex items-center justify-between flex-wrap gap-4 pt-2 border-t border-slate-50">
                  ...
                  <button
                    ...
                    className="flex items-center space-x-1.5 bg-emerald-600 hover:bg-emerald-700 text-white font-bold text-xs px-5 py-3 rounded-xl transition"
                  >
